...
# Convenience function to handle swiftDialog status updates
# usage: update_swift_dialog "status" "message"
function update_swift_dialog () {
    [[ "$enableSwiftDialog" == true ]] || return 0
